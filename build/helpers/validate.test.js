...
describe("validate helpers", function () {
  ...
  var sampleTypeName = "client.phone";
  var sampleTypeValue = "123";
  var sampleValue = "28";
  ...
  it("should validate", function () {
    ...
    expect(helpers.validate(sampleTypeName, sampleTypeValue, { type: "tel" })).toBe("Must be a valid phone number");
