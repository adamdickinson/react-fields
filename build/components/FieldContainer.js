...
var FieldContainer = exports.FieldContainer = function (_React$Component) {
  ...
  _createClass(FieldContainer, [{
    ...
    value: function updateField(name, value) {
      ...
      var state = value !== undefined ? (0, _objectPathImmutable.set)(this.state, name, value) : (0, _objectPathImmutable.del)(this.state, name);
      ...
      var rootState = _defineProperty({}, rootPath, state[rootPath]);
    ...
    value: function validateFields() {
      ...
      fields.forEach(function (field) {
        return _this4.validateField(field, (0, _get2.default)(state, field));
      });
    }
  }, {
    key: "render",
