...
describe("FieldContainer component", function () {
  ...
  it("should activateFields", function () {
    var container = shallow(_react2.default.createElement(_FieldContainer2.default, null)).instance();
    var sampleContext = { activeFields: [], forceUpdate: jest.fn() };
    var activateFields = container.activateFields.bind(sampleContext);

    // Inactive fields
    sampleContext.rules = _defineProperty({}, sampleFieldName, { required: true });
    activateFields();
  ...
  it("should validateFields", function () {
    var _container$rules2;

    var container = new _FieldContainer2.default();
    container.rules = (_container$rules2 = {}, _defineProperty(_container$rules2, sampleFieldName, { required: true }), _defineProperty(_container$rules2, "lastName", { required: true }), _container$rules2);
    ...
    container.validateFields(_defineProperty({}, sampleFieldName, "Adam"));
    expect(container.formValid).toBe(false);
    expect(container.errors).toEqual({
